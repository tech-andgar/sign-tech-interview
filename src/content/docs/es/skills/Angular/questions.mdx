---
title: Angular Entrevista preguntas y respuestas
description: Angular es una plataforma y marco para construir aplicaciones de cliente de una sola página utilizando HTML y TypeScript.
---
